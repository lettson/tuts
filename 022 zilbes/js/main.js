...
var words = wordsListLv
var wordsSounds = wordsSoundsLv

document.getElementById("lang-lv").classList.add("d-none");

/* language flags*/
document.getElementById("lang-ru").addEventListener("click", wordEqualsRu);
function wordEqualsRu(){
  words = wordsListRu;
  wordsSounds = wordsSoundsRu;
  removeRuFlag();
  textOutputAndClicks();
}

document.getElementById("lang-lv").addEventListener("click", wordEqualsLv);
function wordEqualsLv(){
  words = wordsListLv;
  wordsSounds = wordsSoundsLv;
  removeLvFlag();
  textOutputAndClicks();
}


function removeRuFlag(){
  document.getElementById("lang-ru").classList.add("d-none");
  document.getElementById("lang-lv").classList.remove("d-none");
}
function removeLvFlag(){
  document.getElementById("lang-lv").classList.add("d-none");
  document.getElementById("lang-ru").classList.remove("d-none");
}
...
function textOutput(){
  ...
  document.getElementById('syllableOne').style.color="black";
  document.getElementById('syllableTwo').style.color="black";
}
...
function highlight(obj){
  var orig = obj.style.color="black";
  obj.style.color = '#f00';
  setTimeout(function(){
